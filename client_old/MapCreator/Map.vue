...
import modal from '../Main/TaskDialog.vue'
import InstrumentPanel from './InstrumentPanel.vue'
import '../../client/src/assets/css/custom-dot.css'
  ...
  data () {
    return {
      ...
      imagesSrc: ['border/air_air/1.png',
        ...
        'border/dungeon/1.png',
        'border/dungeon/2.png',
        'border/dungeon/3.png',
        'border/forest/1.png',
        'border/forest/2.png',
...
.background:before {
  content: '';
  background-image: url('../../client/src/assets/images/special/background.jpg');
  position: absolute;
  margin: 0;
  padding: 0;
  width: 130%;
